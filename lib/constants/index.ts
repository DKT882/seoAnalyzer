...
export const ISSUE_CODES = {
  ...
  INDEXABILITY_SIGNAL_CONFLICT: 'INDEXABILITY_SIGNAL_CONFLICT',
  INDEXABILITY_CONTRADICTION: 'INDEXABILITY_CONTRADICTION',
  ...
  CANONICAL_REDIRECT_CONFLICT: 'CANONICAL_REDIRECT_CONFLICT',
  CANONICAL_CROSS_DOMAIN: 'CANONICAL_CROSS_DOMAIN',
  NOINDEX_CANONICAL_CONFLICT: 'NOINDEX_CANONICAL_CONFLICT',
  REDIRECT_CHAIN: 'REDIRECT_CHAIN',
  ROBOTS_BLOCKS_URL: 'ROBOTS_BLOCKS_URL',
  ROBOTS_SYNTAX_ERROR: 'ROBOTS_SYNTAX_ERROR',
  SITEMAP_CANONICAL_MISMATCH: 'SITEMAP_CANONICAL_MISMATCH',
  HREFLANG_NON_RECIPROCAL: 'HREFLANG_NON_RECIPROCAL',
  HREFLANG_INVALID: 'HREFLANG_INVALID',
  HREFLANG_MISSING_SELF: 'HREFLANG_MISSING_SELF',
  LANGUAGE_MISMATCH: 'LANGUAGE_MISMATCH',
  INTERNAL_LINK_BROKEN: 'INTERNAL_LINK_BROKEN',
  INTERNAL_LINK_REDIRECT: 'INTERNAL_LINK_REDIRECT',
  SCHEMA_INVALID: 'SCHEMA_INVALID',
  SCHEMA_CONTENT_MISMATCH: 'SCHEMA_CONTENT_MISMATCH',
  MIXED_CONTENT_RESOURCE: 'MIXED_CONTENT_RESOURCE',
  RESPONSIVE_SEO_DISCREPANCY: 'RESPONSIVE_SEO_DISCREPANCY',
