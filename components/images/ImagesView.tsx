...
import { ImagesAnalysis } from '@/types';
import { MetricCard } from '@/components/ui/MetricCard';
import { Image as ImageIcon, CheckCircle, AlertTriangle, Search, ExternalLink } from 'lucide-react';
      ...
      >
        <div style={{ display: 'flex', gap: '0.4rem' }}>
          {[
            ...
            { id: 'missing', label: `Missing ALT (${images.missingAlt})` },
            { id: 'hasAlt', label: `With ALT (${images.withAlt})` },
          ].map((btn) => (
            <button
              key={btn.id}
