...
import { TagExplorerData, PageElementItem, PageElementCategory, ElementIssueStatus } from '@seo-analyzer/shared';
import {
  Code,
  Tag,
  Heading,
...
export function TagExplorerView({ tagExplorer }: TagExplorerViewProps) {
  ...
  const categories = [
    ...
    { id: 'images', label: `Images (${tagExplorer.images.length})`, icon: <Image size={15} /> },
