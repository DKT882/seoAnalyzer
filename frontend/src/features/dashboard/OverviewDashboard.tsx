...
import { formatBytes, getScoreColor } from '../../utils/formatters.js';
import {
  FileText,
  Clock,
  Link,
      ...
      >
        ...
        >
          {[
            ...
            { label: 'Links & Images', score: links, weight: '10% weight', tab: 'links', desc: 'Internal links, ALT coverage' },
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
            ...
            <button
              ...
              style={{ background: 'transparent', color: 'var(--primary)', fontSize: '0.825rem', fontWeight: 600 }}
            >
